    ...
    <div className={s.offersBlock}>
      ...
      <div className={s.listProducts}>
        <div className={s.product}>
          <img src="/Ev-Car/images/Offer-1.webp" alt="" className={s.offerImage} />
        ...
        <div className={s.product}>
          <img src="/Ev-Car/images/Offer-2.webp" alt="" className={s.offerImage} />
          <div className={s.desc}>
            <Typography variant={'paragraph'}>
              {'Portable EV Charger'}
            </Typography>
        ...
        <div className={s.product}>
          <img src="/Ev-Car/images/Offer-3.webp" alt="" className={s.offerImage} />
          <div className={s.desc}>
            <Typography variant={'paragraph'}>
